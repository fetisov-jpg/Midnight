from src.core.redis_db import get_redis_conn, get_redis_config, close_redis
from src.core.memcache_db import get_memcache_conn, get_memcache_config, close_memcache
...
async def check_memcache_stats():
    """Получает статистику Memcached"""
    try:
        memcache = await get_memcache_conn()
